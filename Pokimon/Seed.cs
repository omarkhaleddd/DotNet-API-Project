...

{
    public class Seed
    {
        ...
        {
            if (!dataContext.PokimonOwner.Any())
            {
                var pokemonOwners = new List<PokimonOwner>()
                {
                    new PokimonOwner()
                    {
                        Pokemon = new Pokemon()
                        {
                            ...
                            PokimonCategories = new List<PokimonCategory>()
                            {
                                new PokimonCategory { Category = new Category() { Name = "Electric"}}
                            },
                    ...
                    new PokimonOwner()
                    {
                        Pokemon = new Pokemon()
                        {
                            ...
                            PokimonCategories = new List<PokimonCategory>()
                            {
                                new PokimonCategory { Category = new Category() { Name = "Water"}}
                            },
                            Reviews = new List<Review>()
                            {
                                    ...
                                    new PokimonOwner()
                    {
                        Pokemon = new Pokemon()
                        {
                            ...
                            PokimonCategories = new List<PokimonCategory>()
                            {
                                new PokimonCategory { Category = new Category() { Name = "Leaf"}}
                            },
                            Reviews = new List<Review>()
                            {
                ...
                dataContext.PokimonOwner.AddRange(pokemonOwners);
